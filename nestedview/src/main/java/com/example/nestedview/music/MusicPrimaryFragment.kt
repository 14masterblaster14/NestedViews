 ...
 *
 */
class MusicPrimaryFragment : Fragment() {

    companion object {
        // Method for creating new instances of the fragment
        fun getInstance(): MusicPrimaryFragment {
            ...
            val musicPrimaryFragment = MusicPrimaryFragment()
            musicPrimaryFragment.arguments = bundle
            return musicPrimaryFragment
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // return inflater.inflate(R.layout.fragment_music_primary, container, false)
        val view = inflater.inflate(R.layout.fragment_music_primary, container, false)
